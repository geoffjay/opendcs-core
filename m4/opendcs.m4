dnl opendcs.m4
dnl
dnl Copyright 2011 Jens Georg <rygel.m4>
dnl
...
dnl
dnl This file is a modified version of the one in Rygel.
...
# DCS_CHECK_PACKAGES(LIST-OF-PACKAGES,
#   ACTION-IF-FOUND)
# ---------------------------------------
...
# _DCS_ADD_PLUGIN_INTERNAL(NAME-OF-PLUGIN,
